    ...
    <section className="px-4 pb-20 pt-10 sm:px-6 lg:px-8" id="intro-final-cta">
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-3xl text-center flex flex-col items-center">
          ...
          {/* Heading */}
          <h2 className="mt-8 text-4xl font-black tracking-[-0.045em] text-white sm:text-5xl lg:text-6xl font-display leading-[1.1]">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center w-full sm:w-auto">
            ...
            <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.98 }} className="w-full sm:w-auto">
              <Link
                to="/about"
                className="w-full sm:w-56 px-8 py-4 bg-white/10 text-white rounded-full border border-white/15 backdrop-blur-md font-semibold hover:bg-white/15 text-center flex items-center justify-center gap-2 transition-all duration-300"
              >
